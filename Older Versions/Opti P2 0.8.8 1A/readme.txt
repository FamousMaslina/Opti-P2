Opti P2 - an "OS" made in Python. (written for Version 0.8.8| API Version 0.5.1)
...
UpdateLog:
-----1A-----
-Fixed 'upkeep' command. (Cannot delete any other identifier files due to code-breaking bug.)
-Fixed yet another floppy bug
-Updated op2.ini (remids - Delete pycache on startup)
-Updated 'help' command
-Added 'confighelp' command
-Added individual commands for every new entry in the config file
