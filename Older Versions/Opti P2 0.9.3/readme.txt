Opti P2 - an "OS" made in Python. (written for Version 0.9.3| API Version 0.8)
...
-----1A-----
-Features Added:
	Added RAM simulation
	-Added 'flushram' command
	-Added 'ram' command
	-Revamped 'Virtual Command'
	Fixed a bug regarding the importing of OP2 directly
	Added new GPU - 'PS1 GTE'
