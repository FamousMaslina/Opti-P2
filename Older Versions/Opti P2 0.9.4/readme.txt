Opti P2 - an "OS" made in Python. (written for Version RC2-0.9.4| API Version 0.8)
...
-----1A-----
-Features Added:
	-Added 'get_missing_libs' OP2 command
	-Added checks and passes for not needed modules in BIOS and OP2
	-Fixed Award486DX2 BIOS
	-Added QoL (only 1) in BIOS
	-Fixed all the known issues from previous release
