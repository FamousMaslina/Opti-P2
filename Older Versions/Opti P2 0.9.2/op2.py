...
def mainOS():
    ...
    default_commands = ('bios', 'info', 'cls', 'exit', 'help', 'gpu', 'restart', 'gpuinfo', 'modem', 'internet', 'api',
                        'encryp', 'nguess', 'write', 'calc', 'resethardware', 'hardware', 'users', 'virtualcommand',
                        'omclient', 'omserver', 'upkeep', 'remids', 'date', 'hour', 'gen', 'gensys', 'reboot', 'shutdown',
                        'configuration', 'test', 'credits', 'computername', 'manage_extensions')
